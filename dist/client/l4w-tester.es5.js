...
(function () {
  ...
  (function () {
    ...
    var oe = function oe() {
      return void 0 === G && (G = !q && !z && void 0 !== n.g && n.g.process && "server" === n.g.process.env.VUE_ENV), G;
    },
    ...
    var Te = function Te(e) {
      this.value = e, this.dep = new fe(), this.vmCount = 0, H(e, "__ob__", this), Array.isArray(e) ? (Y ? function (e, t) {
        e.__proto__ = t;
      }(e, _e) : function (e, t, n) {
    ...
    function De(e, t) {
      ...
      for (var n, r, i, o = ce ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < o.length; a++) {
        "__ob__" !== (n = o[a]) && (r = e[n], i = t[n], E(e, n) ? r !== i && u(r) && u(i) && De(r, i) : Ie(e, n, i));
      }
    ...
    function Ct(e, t) {
      var n = this._staticTrees || (this._staticTrees = []),
          r = n[e];
      return r && !t || It(r = n[e] = this.$options.staticRenderFns[e].call(this._renderProxy, null, this), "__static__" + e, !1), r;
    }
    ...
    function $t(e, n, r, i, o) {
      ...
      var u = a(c._compiled),
          d = !u;
      this.data = e, this.props = n, this.children = r, this.parent = i, this.listeners = e.on || t, this.injections = vt(c.inject, i), this.slots = function () {
        return l.$slots || yt(e.scopedSlots, l.$slots = gt(r, i)), l.$slots;
    ...
    var Ft = {
      ...
      prepatch: function prepatch(e, n) {
        ...
        !function (e, n, r, i, o) {
          ...
          e.$options._parentListeners = r, Zt(e, r, v), c && (e.$slots = gt(o, i.context), e.$forceUpdate());
        ...
        if (l(e) && (e = u.extend(e)), "function" == typeof e) {
            ...
            if (n && !o(e.owners)) {
              ...
              var d = function d(e) {
                ...
                e && (r.length = 0, null !== c && (clearTimeout(c), c = null), null !== u && (clearTimeout(u), u = null));
                  ...
                  p = $(function (n) {
                e.resolved = qt(n, t), s ? r.length = 0 : d(!0);
              }),
                  h = $(function (t) {
              ...
              return l(v) && (f(v) ? i(e.resolved) && v.then(p, h) : f(v.component) && (v.component.then(p, h), o(v.error) && (e.errorComp = qt(v.error, t)), o(v.loading) && (e.loadingComp = qt(v.loading, t), 0 === v.delay ? e.loading = !0 : c = setTimeout(function () {
          ...
          if (a(e.options.functional)) return function (e, n, r, i, a) {
            ...
            if (o(c)) for (var u in c) {
              l[u] = Pe(u, c, n || t);
            } else o(r.attrs) && jt(l, r.attrs), o(r.props) && jt(l, r.props);
            var d = new $t(r, l, a, i, e),
                f = s.render.call(null, d._c, d);
            if (f instanceof ge) return Rt(f, r, d.parent, s);

            if (Array.isArray(f)) {
              for (var p = ft(f) || [], h = new Array(p.length), v = 0; v < p.length; v++) {
                h[v] = Rt(p[v], r, d.parent, s);
              }
    ...
    function Ht(e, t, n, r, i, c) {
      return (Array.isArray(n) || s(n)) && (i = r, r = n, n = void 0), a(c) && (i = 2), function (e, t, n, r, i) {
        ...
        (Array.isArray(r) && "function" == typeof r[0] && ((n = n || {}).scopedSlots = {
          ...
          return e;
        }(r)), "string" == typeof t) ? (s = e.$vnode && e.$vnode.ns || P.getTagNamespace(t), a = P.isReservedTag(t) ? new ge(P.parsePlatformTagName(t), n, r, void 0, void 0, e) : n && n.pre || !o(c = Fe(e.$options, "components", t)) ? new ge(t, n, r, void 0, void 0, e) : Bt(c, n, e, r, t)) : a = Bt(t, n, e, r);
    ...
    if (q && !J) {
      ...
      vn && "function" == typeof vn.now && hn() > document.createEvent("Event").timeStamp && (hn = function hn() {
        return vn.now();
      });
    }
    ...
    !function (e) {
      e.prototype._init = function (e) {
        ...
        n._uid = Tn++, n._isVue = !0, e && e._isComponent ? function (e, t) {
        ...
        }(n, e) : n.$options = je(Cn(n.constructor), e || {}, n), n._renderProxy = n, n._self = n, function (e) {
          var t = e.$options,
              n = t.parent;
          ...
          var n = e.$options,
              ...
              i = r && r.context;
          e.$slots = gt(n._renderChildren, i), e.$scopedSlots = t, e._c = function (t, n, r, i) {
    ...
    !function (e) {
      ...
      Object.defineProperty(e, "config", t), e.util = {
        ...
        mergeOptions: je,
        defineReactive: Ne
      }, e.set = Ie, e["delete"] = xe, e.nextTick = rt, e.observable = function (e) {
        return Ce(e), e;
      }, e.options = Object.create(null), j.forEach(function (t) {
        e.options[t + "s"] = Object.create(null);
      }), e.options._base = e, I(e.options.components, Ln), function (e) {
        e.use = function (e) {
    ...
    var Zn = Object.create(null),
        er = v("text,number,password,search,email,tel,url");
    ...
    function fr(e, t) {
      ...
      for (n = 0; n < e.length; n++) {
        (r = e[n]).modifiers || (r.modifiers = dr), i[pr(r)] = r, r.def = Fe(t.$options, "directives", r.name);
      }
    ...
    function gr(e, t) {
      ...
      if (!(o(n) && !1 === n.Ctor.options.inheritAttrs || i(e.data.attrs) && i(t.data.attrs))) {
        ...
        for (r in (J || Z) && c.value !== l.value && mr(s, "value", c.value), l) {
          i(c[r]) && (Un(r) ? s.removeAttributeNS(Bn, Hn(r)) : jn(r) || s.removeAttribute(r));
        }
      }
    }

    function mr(e, t, n) {
      e.tagName.indexOf("-") > -1 ? yr(e, t, n) : Pn(t) ? Gn(n) ? e.removeAttribute(t) : (n = "allowfullscreen" === t && "EMBED" === e.tagName ? "true" : t, e.setAttribute(t, n)) : jn(t) ? e.setAttribute(t, function (e, t) {
        return Gn(t) || "false" === t ? "false" : "contenteditable" === e && Fn(t) ? t : "true";
    ...
    function Er(e, t) {
      ...
      if (!(i(r.staticClass) && i(r["class"]) && (i(a) || i(a.staticClass) && i(a["class"])))) {
        var s = function (e) {
          ...
          return i = t.staticClass, a = t["class"], o(i) || o(a) ? Yn(i, qn(a)) : "";
          var i, a;
        }(t),
            l = n._transitionClasses;

        o(l) && (s = Yn(s, qn(l))), s !== n._prevClass && (n.setAttribute("class", s), n._prevClass = s);
      }
    }
    ...
    function jr(e, n, r, i, o, a, s, l) {
      var c;
      (i = i || t).right ? l ? n = "(" + n + ")==='click'?'contextmenu':(" + n + ")" : "click" === n && (n = "contextmenu", delete i.right) : i.middle && (l ? n = "(" + n + ")==='click'?'mouseup':(" + n + ")" : "click" === n && (n = "mouseup")), i.capture && (delete i.capture, n = Rr("!", n, l)), i.once && (delete i.once, n = Rr("~", n, l)), i.passive && (delete i.passive, n = Rr("&", n, l)), i["native"] ? (delete i["native"], c = e.nativeEvents || (e.nativeEvents = {})) : c = e.events || (e.events = {});
      var u = Ur({
        value: r.trim(),
        dynamic: l
      }, s);
    ...
    function Gr(e, t) {
      var n = function (e) {
        ...
        for (_r = e, Ar = kr = Tr = 0; !Yr();) {
          qr(wr = Vr()) ? Kr(wr) : 91 === wr && zr(wr);
        }
    ...
    function zr(e) {
      ...
      for (kr = Ar; !Yr();) {
        if (qr(e = Vr())) Kr(e);else if (91 === e && t++, 93 === e && t--, 0 === t) {
          Tr = Ar;
          break;
        }
      }
    ...
    function ci(e) {
      return Array.isArray(e) ? x(e) : "string" == typeof e ? si(e) : e;
    }
      ...
      if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
        ...
        var p = function (e, t) {
          for (var n, r = {}, i = e; i.componentInstance;) {
            (i = i.componentInstance._vnode) && i.data && (n = li(i.data)) && I(r, n);
          }

          (n = li(e.data)) && I(r, n);

          for (var o = e; o = o.parent;) {
            o.data && (n = li(o.data)) && I(r, n);
          }
    ...
    wi && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Ti = "WebkitTransition", Ci = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (Ni = "WebkitAnimation", Ii = "webkitAnimationEnd"));
    var xi = q ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : function (e) {
      return e();
    };
    ...
    function Fi(e, t) {
      ...
      if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
        for (var a = r.css, s = r.type, c = r.enterClass, u = r.enterToClass, d = r.enterActiveClass, f = r.appearClass, p = r.appearToClass, v = r.appearActiveClass, g = r.beforeEnter, m = r.enter, y = r.afterEnter, b = r.enterCancelled, E = r.beforeAppear, S = r.appear, _ = r.afterAppear, w = r.appearCancelled, A = r.duration, k = en, T = en.$vnode; T && T.parent;) {
        ...
        if (!C || S || "" === S) {
          var N = C && f ? f : c,
            ...
            R && (Di(n, x), Di(n, I)), F.cancelled ? (R && Di(n, N), L && L(n)) : D && D(n), n._enterCb = null;
          });
          e.data.show || ut(e, "insert", function () {
            var t = n.parentNode,
                r = t && t._pending && t._pending[e.key];
            r && r.tag === e.tag && r.elm._leaveCb && r.elm._leaveCb(), O && O(n, F);
          }), M && M(n), R && (Oi(n, N), Oi(n, I), Mi(function () {
            Di(n, N), F.cancelled || (Oi(n, x), j || (Bi(W) ? setTimeout(F, W) : Li(n, s, F)));
          })), e.data.show && (t && t(), O && O(n, F)), R || j || F();
        }
      }
    }
    ...
    function Pi(e, t) {
      ...
      if (!o(n._leaveCb)) {
        var a = r.css,
          ...
          n.parentNode && n.parentNode._pending && (n.parentNode._pending[e.key] = null), b && (Di(n, u), Di(n, d)), _.cancelled ? (b && Di(n, c), g && g(n)) : (t(), v && v(n)), n._leaveCb = null;
        });
    ...
    var Gi = function (e) {
      ...
      function f(e, t) {
        o(e.data.pendingInsert) && (t.push.apply(t, e.data.pendingInsert), e.data.pendingInsert = null), e.elm = e.componentInstance.$el, g(e) ? (m(e, t), y(e)) : (ir(e), t.push(e));
      }
          ...
          if (a(e.isAsyncPlaceholder)) o(t.asyncFactory.resolved) ? C(e.elm, t, n) : t.isAsyncPlaceholder = !0;else if (a(t.isStatic) && a(e.isStatic) && t.key === e.key && (a(t.isCloned) || a(t.isOnce))) t.componentInstance = e.componentInstance;else {
            ...
            i(t.text) ? o(v) && o(m) ? v !== m && function (e, t, n, r, a) {
              for (var s, l, u, f = 0, p = 0, h = t.length - 1, v = t[0], g = t[h], m = n.length - 1, y = n[0], E = n[m], _ = !a; f <= h && p <= m;) {
                i(v) ? v = t[++f] : i(g) ? g = t[--h] : sr(v, y) ? (A(v, y, r, n, p), v = t[++f], y = n[++p]) : sr(g, E) ? (A(g, E, r, n, m), g = t[--h], E = n[--m]) : sr(v, E) ? (A(v, E, r, n, m), _ && c.insertBefore(e, v.elm, c.nextSibling(g.elm)), v = t[++f], E = n[--m]) : sr(g, y) ? (A(g, y, r, n, p), _ && c.insertBefore(e, g.elm, v.elm), g = t[--h], y = n[++p]) : (i(s) && (s = lr(t, f, h)), i(l = o(y.key) ? s[y.key] : w(y, t, f, h)) ? d(y, r, e, v.elm, !1, n, p) : sr(u = t[l], y) ? (A(u, y, r, n, p), t[l] = void 0, _ && c.insertBefore(e, u.elm, v.elm)) : d(y, r, e, v.elm, !1, n, p), y = n[++p]);
              }
    ...
    var Vi = {
      inserted: function inserted(e, t, n, r) {
        ...
        }) : Yi(e, t, n.context), e._vOptions = [].map.call(e.options, Ki)) : ("textarea" === n.tag || er(e.type)) && (e._vModifiers = t.modifiers, t.modifiers.lazy || (e.addEventListener("compositionstart", Qi), e.addEventListener("compositionend", Ji), e.addEventListener("change", Ji), X && (e.vmodel = !0)));
      },
    ...
    function Yi(e, t, n) {
      qi(e, t), (J || Z) && setTimeout(function () {
        qi(e, t);
      }, 0);
    }
    ...
    Nn.config.mustUseProp = Rn, Nn.config.isReservedTag = Jn, Nn.config.isReservedAttr = Wn, Nn.config.getTagNamespace = Xn, Nn.config.isUnknownElement = function (e) {
      if (!q) return !0;
      if (Jn(e)) return !1;
    ...
    }, I(Nn.options.directives, eo), I(Nn.options.components, po), Nn.prototype.__patch__ = q ? Gi : M, Nn.prototype.$mount = function (e, t) {
      ...
      return function (e) {
        ...
        for (t = 0, n = c.length; t < n; t++) {
          if (r = i = c[t].name, o = c[t].value, Qo.test(r)) {
            if (e.hasBindings = !0, (a = ha(r.replace(Qo, ""))) && (r = r.replace(ra, "")), na.test(r)) r = r.replace(na, ""), o = Ir(o), (l = ea.test(r)) && (r = r.slice(1, -1)), a && (a.prop && !l && "innerHtml" === (r = w(r)) && (r = "innerHTML"), a.camel && !l && (r = w(r)), a.sync && (s = Gr(o, "$event"), l ? jr(e, '"update:"+(' + r + ")", s, null, !1, 0, c[t], !0) : (jr(e, "update:" + w(r), s, null, !1, 0, c[t]), T(r) !== w(r) && jr(e, "update:" + T(r), s, null, !1, 0, c[t])))), a && a.prop || !e.component && qo(e.tag, e.attrsMap.type, r) ? Dr(e, r, o, c[t], l) : Lr(e, r, o, c[t], l);else if (Ko.test(r)) r = r.replace(Ko, ""), (l = ea.test(r)) && (r = r.slice(1, -1)), jr(e, r, o, a, !1, 0, c[t], l);else {
              var u = (r = r.replace(Qo, "")).match(ta),
                  d = u && u[1];
              l = !1, d && (r = r.slice(0, -(d.length + 1)), ea.test(d) && (d = d.slice(1, -1), l = !0)), $r(e, r, i, o, d, l, a, c[t]);
            }
          } else Lr(e, r, JSON.stringify(o), c[t]), !e.component && "muted" === r && qo(e.tag, e.attrsMap.type, r) && Dr(e, r, "true", c[t]);
        }
      }(e), e;
    }
      ...
      directives: {
        model: function model(e, t, n) {
          ...
          if ("select" === o) !function (e, t, n) {
            ...
            jr(e, "change", r = r + " " + Gr(t, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]"), null, !0);
            ...
            var d = Gr(t, u);
            l && (d = "if($event.target.composing)return;" + d), Dr(e, "value", "(" + t + ")"), jr(e, c, d, null, !0), (s || a) && jr(e, "blur", "$forceUpdate()");
    ...
    function Ta(e) {
      if (e["static"] = function (e) {
        return 2 !== e.type && (3 === e.type || !(!e.pre && (e.hasBindings || e["if"] || e["for"] || g(e.tag) || !Ea(e.tag) || function (e) {
          for (; e.parent;) {
    ...
    function $a(e) {
      ...
      if (e.modifiers) {
        ...
        return a.length && (i += function (e) {
          return "if(!$event.type.indexOf('key')&&" + e.map(Ra).join("&&") + ")return null;";
    ...
    var ja = {
      ...
      cloak: M
        ...
        Fa = function Fa(e) {
      this.options = e, this.warn = e.warn || Mr, this.transforms = Or(e.modules, "transformCode"), this.dataGenFns = Or(e.modules, "genData"), this.directives = I(I({}, ja), e.directives);
    ...
    function Ka(e, t) {
      ...
      if (e["for"] && !e.forProcessed) return Ya(e, t, Ka);
    ...
    var rs,
      ...
      var n = function (e, t) {
        Bo = t.warn || Mr, Yo = t.isPreTag || O, qo = t.mustUseProp || O, zo = t.getTagNamespace || O, t.isReservedTag, Ho = Or(t.modules, "transformNode"), Go = Or(t.modules, "preTransformNode"), Vo = Or(t.modules, "postTransformNode"), Uo = t.delimiters;
        var n,
            r,
            i = [],
          ...
          for (var n, r, i = [], o = t.expectHTML, a = t.isUnaryTag || O, s = t.canBeLeftOpenTag || O, l = 0; e;) {
            if (n = e, r && Do(r)) {
              var c = 0,
                ...
                return c = r.length, Do(u) || "noscript" === u || (n = n.replace(/<!\--([\s\S]*?)-->/g, "$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g, "$1")), Fo(u, n) && (n = n.slice(1)), t.chars && t.chars(n), "";
              });
              ...
              if (p >= 0) {
                for (S = e.slice(p); !(Io.test(S) || Co.test(S) || Mo.test(S) || Oo.test(S) || (_ = S.indexOf("<", 1)) < 0);) {
                  p += _, S = e.slice(p);
                }
    ...
    ps.NONE = 0, ps.UP = Math.pow(2, 0), ps.DOWN = Math.pow(2, 1), ps.LEFT = Math.pow(2, 2), ps.RIGHT = Math.pow(2, 3), ps.ALL = ps.UP + ps.DOWN + ps.LEFT + ps.RIGHT;

    var hs = function hs() {
      _classCallCheck(this, hs);
    };

    hs.NONE = 0, hs.N = Math.pow(2, 0), hs.S = Math.pow(2, 1), hs.W = Math.pow(2, 2), hs.E = Math.pow(2, 3), hs.NE = Math.pow(2, 4), hs.SE = Math.pow(2, 5), hs.SW = Math.pow(2, 6), hs.NW = Math.pow(2, 7), hs.ALL = Math.pow(2, 8) - 1;
    var vs = [hs.N, hs.NE, hs.E, hs.SE, hs.S, hs.SW, hs.W, hs.NW];
    var gs, ms, ys, bs;
    !function (e) {
      e.IT = "it", e.EN = "en";
    }(gs || (gs = {})), function (e) {
      ...
      e.mergeRectangles = function (e, t) {
        ...
        var i = 0;
        return i |= e ? ps.UP : 0, i |= t ? ps.DOWN : 0, i |= n ? ps.LEFT : 0, i |= r ? ps.RIGHT : 0, i;
        ...
        return !ys.isEmpty(e) && !Number.isNaN(e) && e >= 0 && e <= 4 ? e : 0;
      }, e.getDirectionName = s, e.getBlockName = function (e) {
        var t = "free";
        return r(e, ps.UP) && (t = s(0)), r(e, ps.DOWN) && (t += s(2)), r(e, ps.LEFT) && (t += s(3)), r(e, ps.RIGHT) && (t += s(1)), t;
    ...
    !function (e) {
      ...
      function i() {
        ...
        return e.name = Es.hero.name, e.i = Es.maps.start.i, e.j = Es.maps.start.j, e.states = [], e.states[0] = {
          direction: 2,
          condition: "always",
          trigger: 0
        }, e.states[0].charaset = Es.hero.charaset, e;
      }
    ...
    !function (e) {
      ...
      i.LEFT = 1, i.RIGHT = 2, i.MIDDLE = 4, e.MouseButtons = i, e.init = function (e, n, i, a, s, l, c, u, d, f, p, h, v, g, m) {
        var y,
            b = !1;
    ...
    function Ds(e, t) {
      ...
      var r = function r(e) {
        e.key === n && (t(e), function () {
          var _iterator3 = _createForOfIteratorHelper(Os),
              _step3;
      ...
      Os.push(r), document.addEventListener("keydown", r);
    }
    ...
    !function (e) {
      ...
      function o(e) {
        return new Promise(function (t) {
          void 0 !== e ? setTimeout(function () {
            ...
            Ms.addActionCallback(n), e.onclick = n, e.style.cursor = "pointer";
          }, 500);
        });
      }

      function a(e, t, n) {
        tl.load(e, Ts.STRING, function (t) {
          ys.isEmpty(t) || "string" != typeof t ? (console.error("Error while loading string: " + e), n()) : n(t);
        }, t);
      }

      function s(e, t, n) {
        e !== Ss.DEFAULT_ID ? tl.load(e + "", Ts.DIALOG, function (t) {
          if (ys.isEmpty(t) || "string" != typeof t) console.error("Error while loading dialog: " + e), n(Ss.getDialogNode(Ss.FIRST_ELEM_ID));else {
            var _e4 = JSON.parse(t),
              ...
              return console.error("Cannot reconstruct dialog tree from node: " + e), Ss.getDialogNode();
            }(Ss.FIRST_ELEM_ID, _e4.nodes, _e4.edges);

            n(_r2);
          }
        }, t) : n(Ss.getDialogNode(Ss.FIRST_ELEM_ID));
      }

      function l(e, t, n) {
        if (e.referenced = !0, !ys.isEmpty(e.edgeIds)) {
      ...
      function u(e, t, a, s, l, c, f) {
        ...
        r(), ys.isEmpty(l) ? console.error("skin is not defined!") : p.style.borderImageSource = "url('/assets/skin/" + l + "')";
        var m = s.face;
        ...
        var y = function (e) {
          ...
          return void 0 !== e.genericMessage && (t = function (e) {
            ...
            if (void 0 !== t && !ys.isEmpty(t.values)) {
              var _e9, _n4;

              if (_e9 = void 0 === t.condition ? t.values : t.values.filter(function (e) {
                return d(t.condition, e.conditionParams);
              }), 0 === _e9.length) return;
              return _n4 = 1 === _e9.length ? 0 : bs.getRandomInteger(0, _e9.length - 1), _e9[_n4].message;
            }
        ...
        var S = function S(n) {
          ...
          if (void 0 !== n.action) {
            ...
            _i5 = _o3.value, _i5 = _i5.trim(), _i5 = Ms.escapeText(_i5), r = c(e, n, t, a, _i5);
          }
      ...
      e.openDialog = r, e.closeDialog = i, e.loadString = a, e.saveString = function (e, t, n) {
        ...
        tl.save(e + "", r, Ts.STRING, function (t, r) {
          if (void 0 !== t) {
            var _e15 = parseInt(t);
        ...
        tl.save(e + "", JSON.stringify(o), Ts.DIALOG, function (t, r) {
          r ? (ys.isNumeric(t) && (e = parseInt(t)), n(e)) : n();
        });
      }, e.deconstructDialogTree = c, e.loadGenericMessages = function (e, t, r) {
        isNaN(e) ? r(!1) : tl.load(e + "", Ts.GENERIC_MESSAGE, function (t) {
          ys.isEmpty(t) || "string" != typeof t ? (console.error("Error while loading dialog: " + e), r(!1)) : (n = JSON.parse(t), r(!0));
        });
        ...
        a(r, i.lang, function (r) {
          var a = Ss.getDialogNode();
          a.message = r, u(e, t, n, a, i.skin, xs, o);
        });
      ...
      e.setFrequency = t, e.setSpeed = n, e.isVisible = function (e, t) {
        return !(void 0 === e || t !== (0 !== bs.normalizeZIndex(e.onTop)) || !ys.isEmpty(e.visible) && !e.visible || !ys.isEmpty(e.opacity) && 0 === e.opacity || ys.isEmpty(e.charaset));
      }, e.initTransientData = function (e, r) {
        return void 0 === r && (r = Ss.getCharacter()), n(r, r.speed), t(r, r.frequency), r;
      };
    }($s || ($s = {})), function (e) {
      ...
      e.loadTileset = function (e, t, n) {
        tl.load(e + "", Ts.TILESET, function (r) {
          if (ys.isEmpty(r)) console.error("Error while loading tileset: " + e), n();else try {
            var _e16 = JSON.parse(r);

            n(_e16);
          } catch (r) {
            "SyntaxError" === r.name ? console.error("Error while parsing tileset: " + e) : "TypeError" === r.name ? console.error("Error while reading tileset: " + e) : console.error(r), Rs.showError(t), n();
          }
        });
        ...
        return new Promise(function (n) {
          var r = n;
          tl.load("autotilesets", Ts.AUTOTILESET, function (n) {
            ...
            try {
              var _loop2 = function _loop2() {
                ...
                void 0 === n.imageData ? tl.load(n.image, Ts.AUTOTILE, function (e) {
        ...
        void 0 === e.animationStartTime && (e.animationStartTime = ys.now());
        var t = ys.now() - e.animationStartTime;
    ...
    !function (e) {
      ...
      e.getSave = function (e, n) {
        if (ys.isEmpty(e) || ys.isEmpty(n)) return Ss.getSave();
        var r = new Array();

        if (!ys.isEmpty(e.events)) {
        ...
        Ps.loadMap(t, e.context.canvas, function (t) {
          var i = t;
          !function (e, t) {
            if (ys.isEmpty(e) || ys.isEmpty(t.events) || ys.isEmpty(e.maps[t.id])) return;
            ...
            if (e.resetTranslation(), e.hero.i = n.i, e.hero.j = n.j, Bs.initTransientData(i, e.grid, e.hero), e.focus = e.grid.mapCellToCanvas(n), !ys.isEmpty(e.map.events)) for (var _t7 = 0; _t7 < e.map.events.length; _t7++) {
    ...
    var Gs = /*#__PURE__*/function (_ref) {
      ...
      _createClass(Gs, [{
          ...
          if (!ys.isEmpty(this.map.events)) {
            ...
            try {
              for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
                ...
                void 0 !== _r5 && this.eventScriptLauncher(_t8, this, this.hero, _r5), e = e || Bs.manageMovements(this.map, this.grid, _t8, Is, Is);
              }
            } catch (err) {
              _iterator16.e(err);
            } finally {
        ...
        value: function loadSave(e, t) {
          ...
          if (void 0 === e) {
            if (!ys.isEmpty(this.map)) return void t(!1);
            n = Es.maps.start.map, r = Ss.getHero();
          } else this.save = e, n = e.currentMap, r = e.hero;

          var i = Bs.initTransientData(this.map, this.grid, r);
          void 0 === i ? console.error("Cannot initialize hero event") : this.hero = i, Fs.loadMapSave(this, n, r, t);
        }
      }, {
        key: "registerAction",
        ...
        value: function setLanguage(e) {
          void 0 === this.save && (this.save = Ss.getSave()), this.save.config.lang = e;
        }
      }, {
      ...
      _createClass(_class, [{
        ...
        value: function togglePause(e) {
          this.paused = null != e ? e : !this.paused, this.paused ? this.pauseStartTime = ys.now() : (void 0 === this.pauseStartTime && (this.pauseStartTime = 0), this.pauseDuration = ys.now() - this.pauseStartTime, this.pauseStartTime = void 0);
        }
      }, {
        key: "changeMap",
        value: function changeMap(e, t) {
          this.togglePause(!0);
          var n = this;
          ys.isEmpty(e) && (console.error("Uninitialized map"), console.trace()), n.map = e, n.changeTile(e.tileset.image, function (e) {
        ...
        value: function changeTile(e, t) {
          var n = this;
          js.loadTileset(e, this.context, function (r) {
            if (void 0 === r) return console.error("Cannot change tile, tileset not found: " + e), void t(n);
            n.map.tileset = r, tl.load(r.image, Ts.TILE, function (e) {
        ...
        value: function render(e, t) {
          ...
          if (!ys.isEmpty(e) && void 0 !== e.tileset.imageData) {
            for (var _s3 = r; _s3 <= i; _s3++) {
              for (var _r6 = o; _r6 <= a; _r6++) {
                var _i6 = bs.cellToGid({
                  i: _r6,
                  j: _s3
                }, e.width);
                ...
                for (var _o6 = Ws.MapLayer.LOW; _o6 <= Ws.MapLayer.TOP; _o6++) {
                  ...
                  if (null != _l) if (Ps.isThisAnAutotileCell(_i6, _a3, e)) {
                    ...
                    if (void 0 !== _n9.imageData) {
                      var _e20 = hs.ALL;
                      void 0 !== _a3.autotileData && null !== _a3.autotileData[_i6] && (_e20 = _a3.autotileData[_i6]), this.applyLayerCustomizations(_o6), ys.isEmpty(_a3.opacity) || (t.globalAlpha = _a3.opacity), this.renderAutotile(t, _n9, _l, _e20, {
                        i: _r6,
                        j: _s3
                    ...
                    var _i7 = 0;
                    void 0 !== e.tileset.onTop && (_i7 = bs.normalizeZIndex(e.tileset.onTop[_l])), 0 !== _i7 && n || (this.applyLayerCustomizations(_o6), ys.isEmpty(_a3.opacity) || (t.globalAlpha = _a3.opacity), this.renderCell(t, e.tileset, _l, _r6, _s3), t.globalAlpha = 1, this.removeLayerCustomizations(_o6));
                  }
                }
              ...
              for (var _i8 = o; _i8 <= a && n; _i8++) {
                for (var _n10 = r; _n10 <= _s4; _n10++) {
                  ...
                  for (var _o7 = Ws.MapLayer.LOW; _o7 <= Ws.MapLayer.TOP; _o7++) {
                    ...
                    if (ys.isEmpty(_l2)) continue;
                    var _c = 0;
                    void 0 !== e.tileset.onTop && (_c = bs.normalizeZIndex(e.tileset.onTop[_l2])), _c > 0 && _n10 + _c === _s4 && (this.applyLayerCustomizations(_o7), ys.isEmpty(_a4.opacity) || (t.globalAlpha = _a4.opacity), this.renderCell(t, e.tileset, _l2, _i8, _n10), t.globalAlpha = 1, this.removeLayerCustomizations(_o7));
                  }
                }
              }
        ...
        value: function renderCell(e, t, n, r, i) {
          var o = bs.gidToCell(n, Math.floor(t.imageWidth / this.grid.cellW));
        ...
        value: function renderAutotile(e, t, n, r, i) {
          ...
          switch (r) {
            case hs.N | hs.E | hs.S | hs.W:
              o = 2, a = 0;
              break;

            case hs.E | hs.S:
            case hs.E | hs.S | hs.NE:
            case hs.E | hs.S | hs.SW:
            case hs.E | hs.S | hs.NE | hs.SW:
            case hs.E | hs.S | hs.NW:
            case hs.E | hs.S | hs.NW | hs.NE:
            case hs.E | hs.S | hs.NW | hs.SW:
            case hs.E | hs.S | hs.NW | hs.NE | hs.SW:
              l = !0;

            case hs.E | hs.SE | hs.S:
            case hs.E | hs.SE | hs.S | hs.NE:
            case hs.E | hs.SE | hs.S | hs.SW:
            case hs.E | hs.SE | hs.S | hs.NE | hs.SW:
            case hs.E | hs.SE | hs.S | hs.NW:
            case hs.E | hs.SE | hs.S | hs.NW | hs.NE:
            case hs.E | hs.SE | hs.S | hs.NW | hs.SW:
            case hs.E | hs.SE | hs.S | hs.NW | hs.NE | hs.SW:
              o = 0, a = 1;
              break;

            case hs.W | hs.SW | hs.S | hs.SE | hs.E:
            case hs.W | hs.SW | hs.S | hs.SE | hs.E | hs.NW:
            case hs.W | hs.SW | hs.S | hs.SE | hs.E | hs.NE:
            case hs.W | hs.SW | hs.S | hs.SE | hs.E | hs.NW | hs.NE:
              o = 1, a = 1;
              break;

            case hs.W | hs.S:
            case hs.W | hs.S | hs.NW:
            case hs.W | hs.S | hs.SE:
            case hs.W | hs.S | hs.NW | hs.SE:
            case hs.W | hs.S | hs.NE:
            case hs.W | hs.S | hs.NE | hs.NW:
            case hs.W | hs.S | hs.NE | hs.SE:
            case hs.W | hs.S | hs.NE | hs.NW | hs.SE:
              l = !0;

            case hs.W | hs.SW | hs.S:
            case hs.W | hs.SW | hs.S | hs.NW:
            case hs.W | hs.SW | hs.S | hs.SE:
            case hs.W | hs.SW | hs.S | hs.NW | hs.SE:
            case hs.W | hs.SW | hs.S | hs.NE:
            case hs.W | hs.SW | hs.S | hs.NE | hs.NW:
            case hs.W | hs.SW | hs.S | hs.NE | hs.SE:
            case hs.W | hs.SW | hs.S | hs.NE | hs.NW | hs.SE:
              o = 2, a = 1;
              break;

            case hs.N | hs.NE | hs.E | hs.SE | hs.S:
            case hs.N | hs.NE | hs.E | hs.SE | hs.S | hs.NW:
            case hs.N | hs.NE | hs.E | hs.SE | hs.S | hs.SW:
            case hs.N | hs.NE | hs.E | hs.SE | hs.S | hs.NW | hs.SW:
              o = 0, a = 2;
              break;
            ...
            case hs.N | hs.NW | hs.W | hs.SW | hs.S:
            case hs.N | hs.NW | hs.W | hs.SW | hs.S | hs.NE:
            case hs.N | hs.NW | hs.W | hs.SW | hs.S | hs.SE:
            case hs.N | hs.NW | hs.W | hs.SW | hs.S | hs.NE | hs.SE:
              o = 2, a = 2;
              break;

            case hs.N | hs.E:
            case hs.N | hs.E | hs.NW:
            case hs.N | hs.E | hs.SE:
            case hs.N | hs.E | hs.NW | hs.SE:
            case hs.N | hs.E | hs.SW:
            case hs.N | hs.E | hs.SW | hs.NW:
            case hs.N | hs.E | hs.SW | hs.SE:
            case hs.N | hs.E | hs.SW | hs.NW | hs.SE:
              l = !0;

            case hs.N | hs.NE | hs.E:
            case hs.N | hs.NE | hs.E | hs.NW:
            case hs.N | hs.NE | hs.E | hs.SE:
            case hs.N | hs.NE | hs.E | hs.NW | hs.SE:
            case hs.N | hs.NE | hs.E | hs.SW:
            case hs.N | hs.NE | hs.E | hs.SW | hs.NW:
            case hs.N | hs.NE | hs.E | hs.SW | hs.SE:
            case hs.N | hs.NE | hs.E | hs.SW | hs.NW | hs.SE:
              o = 0, a = 3;
              break;

            case hs.W | hs.NW | hs.N | hs.NE | hs.E:
            case hs.W | hs.NW | hs.N | hs.NE | hs.E | hs.SW:
            case hs.W | hs.NW | hs.N | hs.NE | hs.E | hs.SE:
            case hs.W | hs.NW | hs.N | hs.NE | hs.E | hs.SW | hs.SE:
              o = 1, a = 3;
              break;

            case hs.W | hs.N:
            case hs.W | hs.N | hs.SW:
            case hs.W | hs.N | hs.NE:
            case hs.W | hs.N | hs.SW | hs.NE:
            case hs.W | hs.N | hs.SE:
            case hs.W | hs.N | hs.SE | hs.SW:
            case hs.W | hs.N | hs.SE | hs.NE:
            case hs.W | hs.N | hs.SE | hs.SW | hs.NE:
              l = !0;

            case hs.W | hs.NW | hs.N:
            case hs.W | hs.NW | hs.N | hs.SW:
            case hs.W | hs.NW | hs.N | hs.NE:
            case hs.W | hs.NW | hs.N | hs.SW | hs.NE:
            case hs.W | hs.NW | hs.N | hs.SE:
            case hs.W | hs.NW | hs.N | hs.SE | hs.SW:
            case hs.W | hs.NW | hs.N | hs.SE | hs.NE:
            case hs.W | hs.NW | hs.N | hs.SE | hs.SW | hs.NE:
              o = 2, a = 3;
              break;

            default:
              if (0 == (r & (hs.N | hs.E | hs.S | hs.W))) {
                o = 0, a = 0;
                break;
              }

              o = 1, a = 2, (r & (hs.N | hs.E)) != (hs.N | hs.E) && (r & (hs.S | hs.E)) != (hs.S | hs.E) && (r & (hs.S | hs.W)) != (hs.S | hs.W) && (r & (hs.N | hs.W)) != (hs.N | hs.W) || (l = !0), (r & (hs.N | hs.S)) > 0 && (0 == (r & hs.W) || 0 == (r & hs.E)) ? c = !0 : (r & (hs.W | hs.E)) > 0 && (0 == (r & hs.N) || 0 == (r & hs.S)) && (u = !0);
          }

          var d = js.getAnimatedAutotileFrame(t);
          ...
          if (e.drawImage(s, (o + d) * this.grid.cellW, a * this.grid.cellH, this.grid.cellW, this.grid.cellH, i.i * this.grid.cellW, i.j * this.grid.cellH, this.grid.cellW, this.grid.cellH), l) {
            ...
            0 == (r & hs.NW) && (r & (hs.N | hs.W)) == (hs.N | hs.W) && (_t10 = 0, _n11 = 0, this.drawAngle(e, s, o + d, a, _l3, _c2, i, _t10, _n11)), 0 == (r & hs.NE) && (r & (hs.N | hs.E)) == (hs.N | hs.E) && (_t10 = _l3, _n11 = 0, this.drawAngle(e, s, o + d, a, _l3, _c2, i, _t10, _n11)), 0 == (r & hs.SW) && (r & (hs.S | hs.W)) == (hs.S | hs.W) && (_t10 = 0, _n11 = _c2, this.drawAngle(e, s, o + d, a, _l3, _c2, i, _t10, _n11)), 0 == (r & hs.SE) && (r & (hs.S | hs.E)) == (hs.S | hs.E) && (_t10 = _l3, _n11 = _c2, this.drawAngle(e, s, o + d, a, _l3, _c2, i, _t10, _n11));
          }
          ...
          if (c) {
            ...
            a = 2;
            var _l4 = 0;
            0 == (r & hs.W) && (o = 0, _t11 = 0, this.drawBottleneck(e, s, o + d, a, i, _t11, _l4, _n12)), 0 == (r & hs.E) && (o = 2, _t11 = Math.floor(this.grid.cellW / 2), this.drawBottleneck(e, s, o + d, a, i, _t11, _l4, _n12)), 0 == (r & hs.N) ? (o = 0, a = 0, _t11 = 0, _l4 = 0, _n12 = {
              w: this.grid.cellW,
              h: Math.floor(this.grid.cellH / 2)
            }, this.drawBottleneck(e, s, o + d, a, i, _t11, _l4, _n12)) : 0 == (r & hs.S) && (o = 0, a = 0, _t11 = 0, _l4 = Math.floor(this.grid.cellH / 2), _n12 = {
              w: this.grid.cellW,
              h: Math.floor(this.grid.cellH / 2)
            ...
            0 == (r & hs.N) && (a = 1, _n13 = 0, this.drawBottleneck(e, s, o + d, a, i, _l5, _n13, _t12)), 0 == (r & hs.S) && (a = 3, _n13 = Math.floor(this.grid.cellH / 2), this.drawBottleneck(e, s, o + d, a, i, _l5, _n13, _t12)), 0 == (r & hs.E) ? (o = 0, a = 0, _l5 = Math.floor(this.grid.cellW / 2), _n13 = 0, _t12 = {
              w: Math.floor(this.grid.cellW / 2),
              h: this.grid.cellH
            }, this.drawBottleneck(e, s, o + d, a, i, _l5, _n13, _t12)) : 0 == (r & hs.W) && (o = 0, a = 0, _l5 = 0, _n13 = 0, _t12 = {
              w: Math.floor(this.grid.cellW / 2),
              h: this.grid.cellH
    ...
    function Vs(e, t, n) {
      var r = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : ms.D_STAR_LITE;
      var i = ys.now(),
          o = n.i - t.i,
          a = n.j - t.j;
      if (0 === o && 0 === a) return 4;
      {
        ...
        switch (r) {
          ...
          case ms.D_STAR_LITE:
            _o8 = function (e, t, n) {
              ...
              function y(t) {
                var n = bs.cellToGid(t.cell, e.width),
                    i = [];
              ...
              function E(t, n) {
                var r = bs.getDirection(n.cell, t.cell),
                    i = 4 === bs.getDirection(n.cell, c.cell);
                return bs.isMovementBlocked(e, t.cell.i, t.cell.j, r, i) ? s : 1;
              }
              ...
              return l = {
                ...
                for (function () {
                  ...
                  return l = _r8, _i9 >= s ? Ys(e, t, n) : bs.getDirection(l.cell, t);
                }
        ...
        4 !== _o8 && (Bs.addDirectionToPath(t, _o8, 3), void 0 === t.path && (t.path = []), 3 === t.path.length && t.path[0] === t.path[2] && bs.isDirectionsOpposed(t.path[0], t.path[1]) && (_o8 = 4));
    ...
    !function (e) {
      function t(e, t, n, r) {
        ...
        var _iterator27 = _createForOfIteratorHelper(vs),
            _step27;
        ...
        try {
          for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
            ...
            var _a6 = bs.getTargetGID(e, _o9, t);
      ...
      function n(e, t) {
        ...
        try {
          for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
            ...
            if (void 0 === _n19 || ys.isEmpty(_n19.block) || _n19.block) {
              var _n20 = bs.cellToGid(_e31, t.width);

              t.dynamicBlocks[_n20] = ps.ALL;
            }
          }
        } catch (err) {
          _iterator28.e(err);
      ...
      e.loadMap = function (e, t, n) {
        tl.load(e + "", Ts.MAP, function (r) {
          if (ys.isEmpty(r)) console.error("Error while loading map: " + e), n();else try {
            var _e32 = JSON.parse(r);

            n(_e32);
          } catch (i) {
            "SyntaxError" === i.name ? console.error("Error while parsing map: " + e) : "TypeError" === i.name ? console.error("Error while reading map: " + e) : console.error(i), console.error(r), Rs.showError(t.getContext("2d")), n();
          }
        });
      }, e.renderUI = function (e, t, n, r, i, o, a) {
        if ((a || r.showGrid || r.showEditorGrid || r.showFocus || r.showBlocks || r.showOnTops) && (!a || r.showFPS || r.showCellNumbers || r.showFocus) && !ys.isEmpty(r)) {
          if (!a && r.showBlocks && !ys.isEmpty(e) && (!ys.isEmpty(e.blocks) || !ys.isEmpty(e.dynamicBlocks))) {
            n.save(), n.globalAlpha = .5, n.fillStyle = Ws.Color.YELLOW, n.strokeStyle = Ws.Color.BLACK, n.lineWidth = 2;

            var _r11 = ys.isEmpty(e.blocks) ? ps.NONE : e.blocks[o * e.width + i],
                _a7 = ys.isEmpty(e.dynamicBlocks) ? ps.NONE : e.dynamicBlocks[o * e.width + i];

            (_r11 > ps.NONE || _a7 > ps.NONE) && (_a7 > ps.NONE && (n.fillStyle = Ws.Color.GREEN), bs.isBlockDirectionBlocked(_r11 | _a7, ps.UP) && (n.beginPath(), n.moveTo(i * t.cellW, o * t.cellH), n.lineTo((i + .5) * t.cellW, (o + .2) * t.cellH), n.lineTo((i + 1) * t.cellW, o * t.cellH), n.fill(), n.stroke()), bs.isBlockDirectionBlocked(_r11 | _a7, ps.DOWN) && (n.beginPath(), n.moveTo(i * t.cellW, (o + 1) * t.cellH), n.lineTo((i + .5) * t.cellW, (o + .8) * t.cellH), n.lineTo((i + 1) * t.cellW, (o + 1) * t.cellH), n.fill(), n.stroke()), bs.isBlockDirectionBlocked(_r11 | _a7, ps.LEFT) && (n.beginPath(), n.moveTo(i * t.cellW, o * t.cellH), n.lineTo((i + .2) * t.cellW, (o + .5) * t.cellH), n.lineTo(i * t.cellW, (o + 1) * t.cellH), n.fill(), n.stroke()), bs.isBlockDirectionBlocked(_r11 | _a7, ps.RIGHT) && (n.beginPath(), n.moveTo((i + 1) * t.cellW, o * t.cellH), n.lineTo((i + .8) * t.cellW, (o + .5) * t.cellH), n.lineTo((i + 1) * t.cellW, (o + 1) * t.cellH), n.fill(), n.stroke())), n.restore();
          }

          if (!a && r.showOnTops && !ys.isEmpty(e) && !ys.isEmpty(e.tileset.onTop)) {
            var _r12 = bs.cellToGid({
              i: i,
              j: o
            }, e.width);

            bs.normalizeZIndex(e.tileset.onTop[_r12]) > 0 && (n.save(), n.globalAlpha = .6, n.beginPath(), n.fillStyle = Ws.Color.AQUA, n.arc(Math.floor((i + .5) * t.cellW), Math.floor((o + .5) * t.cellH), 10, 0, Ws.DOUBLE_PI), n.closePath(), n.fill(), n.fillStyle = Ws.Color.DARKBLUE, n.font = "bold 14px Arial", n.fillText("" + e.tileset.onTop[_r12], (i + .35) * t.cellW, (o + .65) * t.cellH), n.restore());
          }
        ...
        var r = e.width,
            ...
            o = e.height,
            a = n;
        if (r === i && o === a || ys.isEmpty(e)) return;
        var s,
            l,
            c = Math.min(r, i);
        if (i < r) s = r - i;else {
        ...
        var a,
            s = i.map,
            l = i.grid;
        i instanceof Gs && (a = i.hero), js.initTransientData(s.tileset, l), function (n, r) {
          ys.isEmpty(n.autotilesets) ? r() : js.initTransientDataAutotiles(Object.values(n.autotilesets)).then(function () {
          ...
          if (function (e) {
            if (e.blocks = [], !ys.isEmpty(e.layers) && !ys.isEmpty(e.tileset.blocks)) {
              ...
              for (var _t27 = 0; _t27 < e.layers.length; _t27++) {
                ...
                if (void 0 !== _n23.data) for (var _t28 = 0; _t28 < _n23.data.length; _t28++) {
                  ...
                  if (r(_t28, _n23, e)) {
                    ...
                    void 0 === e.autotilesets || void 0 === e.autotilesets[_r17] ? console.warn("Autotile: NaN" + _t28 + " in map: " + e.id) : _i12 = e.autotilesets[_r17].blocked ? ps.ALL : ps.NONE;
                  } else {
                    var _r18 = _n23.data[_t28];
                    if (null === _r18 || _r18 < 0 || _r18 >= e.tileset.blocks.length) continue;
                    if (void 0 !== e.tileset.onTop && bs.normalizeZIndex(e.tileset.onTop[_r18]) > 0) continue;
                    _i12 = e.tileset.blocks[_r18];
                  }

                  void 0 === _i12 && (_i12 = ps.NONE), e.blocks[_t28] = _i12;
                }
              }
            }
          }(s), n(a, s), ys.isEmpty(s.events)) s.events = [];else {
            s.maxEventId = 0;
        ...
        var o = bs.getDirectionTarget({
          i: t,
          j: n
        }, r),
            a = !1;
        return void 0 !== i && 4 === bs.getDirection(o, i) && (a = !0), bs.isMovementBlocked(e, t, n, r, a);
      ...
      function i(e) {
        ...
        if (void 0 !== t) {
          var _e40 = t.mSpeed;
          if (!ys.isEmpty(_e40)) return _e40;
        }
      ...
      function a(e, t) {
        ...
        void 0 === n && (n = 4);
        var r = bs.getNextAbsoluteDirection(n, 0),
        ...
        if (s > 0) {
          var _e41 = bs.getRandomInteger(1, s);

          _e41 -= i, _e41 <= 0 ? l = r : (_e41 -= o, _e41 <= 0 || (_e41 -= a), l = 4);
        }

        return bs.getDirectionTarget(t, l);
      }

      e.update = function (e, r, i, o, s) {
        var l = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;

        if (ys.isEmpty(e.movementStartTime) || (e.movementStartTime += l), !ys.isEmpty(e.states)) {
          var _s7 = -1;
          ...
          if (-1 !== e.currentState && void 0 !== e.states[e.currentState].movement && void 0 === e.movementStartTime && function (e, t) {
            ...
            switch (o.strategy) {
              ...
              case "event":
                ...
                r = bs.getDirectionTarget(t, _l6), _i14 = function i(r) {
                  var a = Vs(e, t, _s8, o.pathfinder);

                  if (4 !== a) {
                    var _e42 = bs.getDirectionTarget(t, a);
        ...
        if (!ys.isEmpty(o.movementStartTime)) {
          if (0 === l && (l = ys.now() - o.movementStartTime), void 0 === o.target) return console.error("No target set for movement"), !0;

          var _e43,
              _u = o.target,
              _d = function (e, t, n) {
            var r = 4,
                i = bs.cellToGid(n, e.width),
                o = bs.getMapStaticBlock(e, i),
                a = bs.getMapDynamicBlock(e, i);
            if (bs.isBlockDirectionBlocked(o, ps.ALL) && !bs.isBlockDirectionBlocked(a, ps.ALL) || i < 0 || i >= e.width * e.height) r = 4;else if (ys.isEmpty(t.movementDirection) || 4 !== t.movementDirection) {
              try {
                r = Vs(e, t, n);
              } catch (t) {
                console.error(t);
              ...
              var _o12 = bs.getDirectionTarget(t, r),
                  _a11 = bs.cellToGid(_o12, e.width),
                  _s9 = bs.getMapDynamicBlock(e, _a11);

              bs.isDirectionEnumBlocked(_s9, bs.getOpposedDirections(r)) && (r = 4, _a11 === i && void 0 !== t.onTargetReached && t.onTargetReached(n));
          ...
          if (4 !== _d && (void 0 !== o.states[o.currentState] && (o.states[o.currentState].direction = _d), o.movementDirection = _d, o.position = {
            ...
            c = !0, o.movementDirection = void 0, o.movementStartTime = ys.now(), l -= Math.floor(_e43 / i(o));
            ...
            (!ys.isEmpty(o.newTarget) || o.position.x === _a12.x && o.position.y === _a12.y) && r(o);
          }
        }

        return !ys.isEmpty(o.newTarget) && ys.isEmpty(o.movementStartTime) && (o.target = o.newTarget, o.onTargetReached = o.newOnTargetReached, o.newTarget = void 0, o.newOnTargetReached = void 0, o.movementStartTime = ys.now(), c = c || e(t, n, o, a, s, l)), c;
      }, e.addDirectionToPath = function (e, t, n) {
        void 0 === e.path && (e.path = []), e.path[e.path.length - 1] !== t && e.path.push(t), !ys.isEmpty(n) && e.path.length > n && e.path.shift();
      }, e.render = function (e, t, n, r, i) {
        var a,
            s = o(t);
        if (void 0 !== s) if (ys.isEmpty(s.charaset) ? ys.isEmpty(s.gid) || console.warn("Not implemented") : a = tl.loadImageFromCache(s.charaset, Ts.CHAR), void 0 !== t.position) {
          if (r || (n.save(), n.strokeStyle = Ws.Color.GREEN, n.lineWidth = 2, n.strokeRect(t.position.x, t.position.y, e.cellW, e.cellH)), void 0 !== a) {
            ...
            if (_d2 = ys.isEmpty(s.frequencyVal) ? Ws.MEDIUM_FREQUENCY : s.frequencyVal, ys.isEmpty(t.target)) {
              if (1 === s.rotation || 2 === s.rotation) {
                ys.isEmpty(s.animationStartTime) && (s.animationStartTime = ys.now());

                var _e44 = ys.now() - s.animationStartTime;
              ...
              var _e45 = ys.now() - s.animationStartTime;
            ...
            if (n.save(), ys.isEmpty(s.opacity) || 100 === s.opacity || (n.globalAlpha = s.opacity / 100), void 0 !== i && i.i === t.i && i.j === t.j) {
        ...
        return e.i === a && e.j === s && !!$s.isVisible(o(e), l) && e.i >= r && e.i <= i && e.j >= t && e.j <= n;
      }, e.saveMem = function (e, t, n) {
        ys.isEmpty(e.memory) && (e.memory = {}), e.memory[t] = n;
      }, e.loadMem = function (e, t) {
        if (!ys.isEmpty(e.memory)) return e.memory[t];
      }, e.deleteMem = function (e, t) {
        ys.isEmpty(e.memory) || delete e.memory[t];
      }, e.initTransientData = function (t, n, i) {
        if ($s.initTransientData(n, e.getState(i)), void 0 !== i) return r(i), i.position = {
          x: i.i * n.cellW,
          y: i.j * n.cellH
        }, i;
      }, e.getState = o;
    ...
    var qs = /*#__PURE__*/function () {
      ...
      _createClass(qs, [{
        ...
        value: function getConfig() {
          return void 0 !== this.scene.save && void 0 !== this.scene.save.config ? this.scene.save.config : Ss.getConfig();
        }
      }, {
        ...
        value: function stepToTarget(e, t, n) {
          var r = bs.getDirection(t, this.event);
          this.stepToDirection(e, r, n);
        }
      }, {
        key: "stepToDirection",
        value: function stepToDirection(e, t, n) {
          var r = bs.moveToDirection(e, t);
          this.moveToTarget(e, r, n);
        }
      }, {
        key: "stepFromTarget",
        value: function stepFromTarget(e, t, n) {
          var r = bs.getDirection(t, e);
          r = bs.getOpposedDirections(r), this.stepToDirection(e, r, n);
        }
      }, {
        key: "getEventById",
        ...
        value: function incrementStateVar() {
          var e = this.loadMem(ws),
              t = 0;
          return void 0 !== e && (t = Number.parseInt(e), Number.isNaN(t) && (t = 0)), t++, this.saveMem(ws, t + ""), t;
        }
      }, {
        key: "setStateVar",
    ...
    qs.tooltip = "no description provided";
    var zs = "msg",
        Ks = "dlg";

    var Qs = /*#__PURE__*/function (_qs) {
      _inherits(Qs, _qs);
      ...
      _createClass(Qs, [{
        ...
        value: function speak() {
          ...
          ys.isEmpty(e) && (e = this.loadMem(zs)), this.showSimpleDialog(e, Is);
        }
      }, {
        key: "dialog",
        value: function dialog() {
          var e = this.event.states[this.event.currentState];
          void 0 !== e.dialog && this.showComplexDialog(e.dialog, Is);
        }
      }, {
        key: "flee",
        value: function flee() {
    ...
    var Js = /*#__PURE__*/function (_qs2) {
      ...
      _createClass(Js, [{
        ...
        value: function faceTheHero() {
          ...
          void 0 !== e ? e.states[e.currentState].direction = bs.getDirection(this.hero, e) : console.error("Cannot find Ann! id:" + Js.eventId);
        }
      }]);
    ...
    var el = /*#__PURE__*/function (_qs5) {
      ...
      _createClass(el, [{
        ...
        value: function testAction() {
          this.showSimpleDialog("2", Is);
        }
      }, {
        key: "giantTest",
        value: function giantTest() {
          this.showSimpleDialog("4", Is);
          var e = this;
    ...
    el.tooltip = "Script for tests", function (t) {
      ...
      function p(e, t, n, r, i) {
        ...
        try {
          void 0 !== i && o.setRequestHeader("lang", i), ys.isEmpty(t) || e !== Ws.RequestType.POST ? o.send() : o.send(t);
        } catch (e) {
      ...
      function h(e, t, i, o) {
        ys.isEmpty(e) && console.error("Trying to load empty file!");
      ...
      t.loadProperties = function (e) {
        ...
        c.has(t) ? e(c.get(t)) : d(n + Ts.CONFIGURATION + "/" + t + ".properties", function (n) {
          var r;
        ...
        f(i, t, function (e) {
          void 0 !== e ? n === Ts.STRING || n === Ts.DIALOG || n === Ts.GENERIC_MESSAGE ? r(e, !0) : r(void 0, !0) : (console.error("Empty response for: " + i), r(void 0, !1));
        });
        ...
        var t = Object.keys(e).filter(function (t) {
          try {
            return e[t].prototype instanceof qs;
          } catch (e) {
            return !1;
          }
        }),
        ...
        var n = new e[t](void 0, void 0, void 0),
          ...
          try {
            return "constructor" !== e && !ys.isEmpty(e) && "function" == typeof n[e];
          } catch (e) {
            return !1;
          }
        });
          ...
          if (this.description.trim().length > 0) {
            ...
            grecaptcha.ready(function () {
              grecaptcha.execute("6LfudvIUAAAAADY9aLIgdcbuY8kekIKAv6WYEYFb", {
                ...
                fs.set(_e47, "flagSent", !0), tl.sendPOSTRequest("issue", JSON.stringify(n), function (t) {
                  if (fs.set(_e47, "flagReceived", !0), !ys.isEmpty(t)) try {
                    var _n28 = JSON.parse(t);

                    return void fs.set(_e47, "url", _n28.url);
                  } catch (e) {
                    console.error(t);
                  }
                  console.error("Issue creation failed");
    ...
    il.options.__file = "src/client/components/BugReporting.vue";
    var ol = il.exports;
    ...
    n(564);
    var ll = rl(sl, al, [], !1, null, "08ab550b", null);
    ll.options.__file = "src/client/components/Login.vue";
    var cl = ll.exports;
    var ul;
    !function (e) {
      function t(e, t, n, r, i, o, a) {
        var s = Ss.getEmptyMap();
        ...
        switch (d) {
          ...
          default:
            console.error("Unexpected pathfinding algo: " + d), c = ms.BASIC;
        }
        ...
        do {
          if (f = Vs(s, l, u, c), 4 !== f && (l = bs.moveToDirection(l, f), p.push({
            cell: {
              i: l.i,
              j: l.j
            }
